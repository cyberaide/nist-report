...
\begin{table*}[htb]
  \begin{center}
	...
	\begin{tabular}{l|l|l|l|l|l|l|l|l|l|l|l}
	  \hline
	  \blue \textbf{Topic} & \blue \textbf{C++} &  \blue \textbf{Python} &  \blue \textbf{Java} &  \blue \textbf{Matlab} &  \blue \textbf{JS} &  \blue \textbf{C\#} &  \blue \textbf{C} &  \blue \textbf{R} &  \blue \textbf{Ruby} &  \blue \textbf{Scala} &  \blue \textbf{Count\tnote{*}} \tabularnewline \hline
...
\begin{table*}[htb]
  ...
  \begin{tabular}{l|l|l|l|l|l|l}
    ...
    Energy & 2 & 2 & 5 & 1 & 5 & 15 \\ 
  \end{tabular}
  \caption{Public Dataset of acamedia, government, organization, industry and international from Community}
...
\begin{table*}[htb]
  ...
  \end{tabular}
  \caption{List of Top 15 Tools/Libraries/Packages used in Big Data Class Fall 2015}
...
\begin{table*}[htb]
  ...
  \end{tabular}
  \caption{List of Top 15 Tools/Libraries/Packages used in Big Data Class Fall 2016}
...
\begin{table*}[htb]
  ...
  \end{tabular}
  \caption{Dataset Sectors of academia, government, organization, industry and international from Big Data Classes at Indiana University}
