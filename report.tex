...
\begin{figure}[htb]
  \centering
  \begin{subfigure}
      \includegraphics[width=0.3\columnwidth]{images/face01}
    \end{subfigure}%
    \begin{subfigure}
      \includegraphics[width=0.3\columnwidth]{images/face02}
    \end{subfigure}
...
\begin{figure}[htb]
  \centering
  \begin{subfigure}
      \includegraphics[width=0.3\columnwidth]{images/face04}
    \end{subfigure}
    \begin{subfigure}
      \includegraphics[width=0.3\columnwidth]{images/face03}
    \end{subfigure}
